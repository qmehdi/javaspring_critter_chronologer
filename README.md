# Critter Chronologer Project Starter - Huzaifa Ahmed Version
...
`docker run -e "MYSQL_ROOT_PASSWORD=root" -e "MYSQL_ROOT_HOST=%" -p 3306:3306 -d mysql/mysql-server:latest`
